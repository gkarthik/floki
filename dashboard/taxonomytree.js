  ...
  function makescales(d) {
    ...
    if (typeof d.data[scope.colorTax] !== 'undefined') {
      if (typeof d.data[scope.colorTax][0]== 'string') {
        ...
        .domain([mins[scope.colorTax], Math.log(maxs[scope.colorTax])/2, Math.log(maxs[scope.colorTax])])
        .range(["#e62e00", "#ffffb3", "#004080"]);
      }else {
        smolscale = d3.scaleLinear()
        .domain([mins[scope.colorTax], Math.log(maxs[scope.colorTax]*100000)/2, Math.log(maxs[scope.colorTax]*100000)])
        .range(["#e62e00", "#ffffb3", "#004080"]);
      }
    }
    }
